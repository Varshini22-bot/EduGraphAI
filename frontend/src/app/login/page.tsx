    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="card w-full max-w-[400px] px-7 py-7">
        ...
        <p className="mb-5 text-[13px] text-ink-secondary">
          Log in to keep your chats, bookmarks, and progress in sync.
        </p>

        {error && (
          <div className="mb-3 text-[12.5px] text-danger">{error}</div>
        )}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4 text-right">
            <Link href="/forgot-password" className="text-xs font-medium text-teal">
              Forgot password?
            </Link>
          </div>
